...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="#"> <img src="images/logofix.png" width="80px" height="80px"></a>
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="jumbo1">
      <div class="container">
        <h1 class="display-4">Selamat datang di <br> Website Resmi Rumah Sakit ARS</h1>
